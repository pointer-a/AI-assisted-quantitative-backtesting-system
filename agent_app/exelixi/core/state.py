...
from exelixi.core.approval import ApprovalDecision, ApprovalRequest, UserInputRequest, UserInputResponse, normalize_approval_mode
from exelixi.core.checkpoint import normalize_checkpoint_mode
from exelixi.core.trace import normalize_trace_mode
...
class RuntimeState:
    ...
    human_request_handler: Callable[[UserInputRequest], UserInputResponse | str | None] | None = None
